...
function Home({ setCurrentPage, isPro }) {
  return (
    ...
    >
      ...
      {/* LOCAL NAVBAR RENDERING REMOVED:
        This prevents double-navbar rendering conflicts and restores page loading.
        Navigation is handled globally by App.jsx layout wrappers.
      */}
